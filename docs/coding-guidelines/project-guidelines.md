...
```
<PropertyGroup>
  <TargetFrameworks>$(NetCoreAppCurrent);netstandard2.0;$(TargetFrameworkMinimum)</TargetFrameworks>
</PropertyGroup>
...
<ItemGroup Condition="'$(TargetFramework)' == '$(TargetFrameworkMinimum)'">...</ItemGroup>
```
